...
public class ClienteProcessor {
    ...
    private String classifyRegion(String state) {
    	...
    	if (state.equals("amazonas") || state.equals("pará") || state.equals("roraima") || state.equals("amapá") || state.equals("rondônia") || state.equals("acre") || state.equals("tocantins")) {
    	    return "norte";
    	} else if (state.equals("piauí") || state.equals("maranhão") || state.equals("pernambuco") || state.equals("rio grande do norte") || state.equals("paraíba") || state.equals("ceará") || state.equals("bahia") || state.equals("alagoas") || state.equals("sergipe")) {
    	    return "nordeste";
    	} else if (state.equals("mato grosso") || state.equals("mato grosso do sul") || state.equals("goiás") || state.equals("distrito federal")) {
    	    return "centro-oeste";
    	} else if (state.equals("são paulo") || state.equals("rio de janeiro") || state.equals("espírito santo") || state.equals("minas gerais")) {
    	    return "sudeste";
